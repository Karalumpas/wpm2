...
export default function StaticProductsPage() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch('/api/products?sortBy=updatedAt&sortOrder=desc&limit=25');
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Products ({products.length})</h1>
          ...
          <div key={product.id} className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-lg font-bold text-green-600">{product.basePrice} DKK</span>
