    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 max-w-md mx-auto">
          Customize your interface with colors, themes, and visual preferences that match your style.
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Light & Dark Mode</h3>
            <p className="text-sm text-gray-600">Control when to use light or dark interface</p>
          </div>
        </div>
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <div className={`p-2 rounded-lg ${
                    settings.colorMode === mode.id ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-600'
                  }`}>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Customize fonts and text size</p>
          </div>
        </div>
            ...
            {FONT_OPTIONS.map((font) => (
              ...
              >
                ...
                <div 
                  ...
                  style={{ fontFamily: font.id === 'sans' ? 'var(--font-sans)' : font.id === 'serif' ? 'serif' : 'monospace' }}
                >
                  {font.preview}
                </div>
              </button>
        ...
        <div>
          ...
          <label className="inline-flex items-center gap-3 p-4 rounded-xl border border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors">
            <input
              ...
              onChange={(e) => handleUpdateSetting('largeText', e.target.checked)}
              className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
            />
            <div>
              <div className="font-medium text-gray-900">Large text</div>
              <div className="text-sm text-gray-600">Increase base font size for better readability</div>
            </div>
          </label>
        </div>
      </div>
          ...
          <label className="inline-flex items-center gap-3 p-4 rounded-xl border border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Reduce spacing for more content density</div>
              </div>
            </div>
          </label>
        </div>
